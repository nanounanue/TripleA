...
public class LobbyServerProperties
{
	...
	private static Properties getProperties(final URL url)
	{
		...
		// add the proxy
		// GameRunner2.addProxy(config); // since lobby actually uses a different port and connection type (TCP), we should not use a proxy for the properties file until we allow the lobby to accept proxy connections
