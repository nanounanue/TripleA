...
public class OCUnit
{
	...
	{
		OCUnit bbUnit = null;
		bbUnit = new OCUnit(StandardUnits.BBCost, StandardUnits.BBAttack, StandardUnits.BBDefend, StandardUnits.BBMove, StandardUnits.BBName, false, OCUnit.SEAUNIT, true, true, 1, 1, 2, false, false,
					false);
		return bbUnit;
	}
	...
	{
		OCUnit bmb = null;
		bmb = new OCUnit(StandardUnits.BmbCost, StandardUnits.BmbAttack, StandardUnits.BmbDefend, StandardUnits.BmbMove, StandardUnits.BmbName, false, OCUnit.AIRUNIT, false, true, 3, 1, 1, false,
					false, false);
		return bmb;
	}
	...
	{
		OCUnit bmb = null;
		bmb = new OCUnit(StandardUnits.BmbCost, StandardUnits.BmbAttack, StandardUnits.BmbDefend, StandardUnits.BmbMove, StandardUnits.BmbName, false, OCUnit.AIRUNIT, false, true, 1, 2, 1, false,
					false, false);
		return bmb;
	}
	...
	{
		OCUnit des = null;
		des = new OCUnit(StandardUnits.DesCost, StandardUnits.DesAttack, StandardUnits.DesDefend, StandardUnits.DesMove, StandardUnits.DesName, false, OCUnit.SEAUNIT, false, true, 1, 1, 1, true,
					false, false);
		return des;
	}
	...
	{
		OCUnit rtl = null;
		rtl = new OCUnit(StandardUnits.RtlCost, StandardUnits.RtlAttack, StandardUnits.RtlDefend, StandardUnits.RtlMove, StandardUnits.RtlName, false, OCUnit.LANDUNIT, false, false, 1, 1, 1, false,
					true, false);
		return rtl;
	}
